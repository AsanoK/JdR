...
\caption{ Modificateurs aux tests de divination :}
\label{tableModifDivination}
\begin{center}
\begin{tabular}{cccc}
\textbf{Modificateur} & \textbf{éloignement temporel} & \textbf{éloignement spatial}\\
   -1  & au même moment & au même endroit\\
   0  & dans la même semaine & quelques centaines de mètres \\
   +1 & dans le même mois & quelques kilomètres ou lieu inconnu\\
   +2 & dans la même année & quelques dizaines de kilomètres\\
   +3 & plus loin dans le temps & plus loin dans l'espace
\end{tabular}
\end{center}
\end{table*}

\section{Liturgie}
%cérémonies pour attirer la faveur divine sur ses participants
\section{Prières}
%prières pour invoquer une faveur spécifique ou une défaveur sur quelqu'un
\section{Sorcellerie}
